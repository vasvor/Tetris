...
// Создаём конструктор начальных состояний.
...
// Метод ,который разрешает создавать экземпляры блока (Block) др. классам.
    ...
    @NonNull // Аннотация обозначает , что возвращаемый метод getShape() не может быть null.
