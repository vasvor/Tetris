package com.tetrisnoactivity.view
...
import com.tetrisnoactivity.GameActivity
import com.tetrisnoactivity.constants.CellConstants
import com.tetrisnoactivity.constants.FieldConstants
import com.tetrisnoactivity.models.AppModel
import com.tetrisnoactivity.models.Block

class TetrisView: View {
    private val paint = Paint() // Информация о стиле и цвете относящуюся к рисованию текстов, растр. изображений и геометрических построений.
    ...
    private class ViewHandler(private val owner: TetrisView): Handler(Looper.getMainLooper()) {
        ...
        // Удаляет отправленное сообщение  направляет новое сообщ. с задержкойб величина которой указана в delay.
...
// Устанавливает текущую команду перемещения
...
// Обновление текстовых представлений текущего счёта и рекорда
...
// Доступ к значениям ширины и высоты представления
